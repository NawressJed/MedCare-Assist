...
public interface NotificationRepository extends JpaRepository<Notification, UUID> {
    ...
    @Query(value = "SELECT n.* FROM notification AS n WHERE n.appointment_id = :appointmentId", nativeQuery = true)
    Notification findNotificationByAppointment(UUID appointmentId);
}
